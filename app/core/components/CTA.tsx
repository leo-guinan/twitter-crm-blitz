...
const CTA = () => {
  ...
  return (
    ...
    //       <span className="block">Tools for building relationships. Tools for getting your voice heard.</span>
    //       <span className="block text-indigo-500">Feather provides tools for social and media.</span>
    //     </h2>
