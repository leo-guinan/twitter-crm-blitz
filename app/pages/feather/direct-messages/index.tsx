...
const DirectMessagePage: BlitzPage = () => {
  return (
    <>
      <Head>
      ...
      <div>
        <Suspense fallback={<div>Loading...</div>}>
          Coming soon...view your direct messages...
        </Suspense>
      </div>
    </>
  )
...
DirectMessagePage.authenticate = true
DirectMessagePage.getLayout = (page) => <Layout>{page}</Layout>
